...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_retrieve_recipe_list_limited_to_user(self):
        ...
        other_user = create_user(email="other@example.com", password="testpass456")
    ...
    def test_update_user_returns_error(self):
        ...
        new_user = create_user(email="user2@example.com", password="test12354")
        recipe = create_recipe(user=self.user)
...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image(self):
        ...
        with tempfile.NamedTemporaryFile(suffix=".jpg") as image_file:
            ...
            img.save(image_file, ofrmat="JPEG")
            image_file.seek(0)
